...
*
* @page page_API_Revision_History_IBScanException IBScanException.java
* @section section_IBScanException IBScanException.java
* @li @par  2020/04/01
*						Added warning codes\n
*						(SPOOF_INIT_FAILED) 
*
...
*						(DEVICE_NEED_UPDATE_FIRMWARE, API_DEPRECATED, NO_FINGER, INCORRECT_FINGERS, ROLLING_SMEAR).
*
* @li @par  2013/03/22
...
/**
****************************************************************************************************
* @defgroup group_API_Common_Class_IBScanException Class - IBScanException
* @{
****************************************************************************************************
*/
/**
* @brief    Exception thrown when error returned by IB device.
*/
