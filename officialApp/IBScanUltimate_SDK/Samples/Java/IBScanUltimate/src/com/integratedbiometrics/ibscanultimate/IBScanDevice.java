...
public class IBScanDevice
{
	...
	*/
    public static enum ImageType
    {
        ...
        */
         ...
         */
        FLAT_SINGLE_WRITERS_PALM(6, "Palm flat writer's palm"),
        /**
         * Palm flat upper palm.
         */
	...
	*/
    public static class ImageData
    {
        ...
        * 
        * @return [BufferedImage] image if successful; otherwise null
        */
        ...
        //
        /**
        * @brief	Create image from the image data.
        * 
        * @return 	[BufferedImage] image if successful; otherwise null
        */
    ...
    */
    ...
    /** @brief	Native method for wsqEncodeToMemNative(). */
	...
	/** @brief	Native method for SetEncryptionKey(). */
