...
* @section section_IBScanUltimateAPI_defs IBScanUltimateApi_defs.h
* @li @par  2024/03/27  4.0.0
*                               Added an enumeration value to IBSU_PropertyId
*                               (ENUM_IBSU_PROPERTY_DR_MODE_ZOOM_IN)
* @li @par  2022/05/30  3.9.1
*                               Removed ENUM_IBSU_PROPERTY_RESERVED_SPOOF_LEVEL_THRESHOLD
* @li @par  2022/04/13  3.9.0
*                               Added new enumerations & structures to support ISO/ANSI template integration 
*                               (IBSM_TemplateVersion, IBSM_Template, IBSM_StandardFormat,
*                               IBSM_StandardFormatData)
* @li @par  2022/02/18  3.8.1
...
*                               Modified IBSU_DeviceDesc structure for a new locking feature.
*                               Added IBSU_HashType
* @li @par  2020/08/21  3.5.0
*                               Added an enumeration value to IBSU_PropertyId
*                               (ENUM_IBSU_PROPERTY_ADAPTIVE_CAPTURE_MODE,
...
*                               \n
*                               Added a reserved enumeration value to IBSU_PropertyId
...
*                               Added new defines to support image segmentation and bitmap header.
...
*                               roll-fingerprint's width, draw arrow, getting the scale of the displayed
...
*                               available callback.
*                               \n
*                               Added a new enumeration to make overlay object on client window.
*                               (IBSU_OverlayShapePattern)
*                               \n
*                               Added a new callback function (IBSU_CallbackResultImageEx)
* @li @par  2013/08/03  1.6.9
*                               Reformatted.
* @li @par  2013/07/31  1.6.8
*                               Added new defines to support Curve (TBN240) LEDs (IBSU_LED_SCAN_CURVE_RED,
*                               IBSU_LED_SCAN_CURVE_GREEN, IBSU_LED_SCAN_CURVE_BLUE)
* @li @par  2013/03/20  1.6.0
*                               Added new enumerations & structures to support IBScanMatcher integration
...
* @li @par  2013/02/01  1.5.0
*                               Added an enumeration value to IBSU_ImageType (ENUM_IBSU_FLAT_FOUR_FINGERS)
*                               \n
*                               Added an enumeration value to IBSU_PropertyId
...
/**
****************************************************************************************************
* @defgroup group_Definition_General Definition - General
...
/**
****************************************************************************************************
* @defgroup group_Definition_LED Definition - LED
* @brief    LED bit defines.
* @{
****************************************************************************************************
*/
/** All LEDs off. */
...
/**
****************************************************************************************************
* @defgroup group_Definition_LED_Four_Finger_Scanner Definition - LED for 4-Finger Scanners
* @brief    Specific LED bit defines with LED type = ENUM_IBSU_LED_TYPE_FSCAN (e.g four finger scanner, Kojak).
* @{
****************************************************************************************************
*/
...
/**
****************************************************************************************************
* @defgroup group_Definition_Finger_Type Definition - Finger Types
* @brief    Bit-pattern of finger index for IBSU_RemoveFingerImage, IBSU_AddFingerImage, IBSU_IsFingerDuplicated and IBSU_IsValidFingerGeometry.
* @{
****************************************************************************************************
*/
...
/**
****************************************************************************************************
* @defgroup group_Structure_SDK_Version Structure - SDK Version
* @brief    Container to hold SDK version.
* @{
****************************************************************************************************
*/
#ifndef WINCE
...
{
    /** Product version string. */
    wchar_t Product[IBSU_MAX_STR_LEN];
    /** File version string. */
    wchar_t File[IBSU_MAX_STR_LEN];
}
IBSU_SdkVersionW;
...
/**
****************************************************************************************************
* @defgroup group_Structure_Device_Description Structure - Device Description
* @brief    Basic device description.
* @{
****************************************************************************************************
*/
#ifndef WINCE
...
{
    /** Device serial number. */
    wchar_t serialNumber[IBSU_MAX_STR_LEN];
    /** Device product name. */
    wchar_t productName[IBSU_MAX_STR_LEN];
    /** Device interface type (USB, Firewire). */
    wchar_t interfaceType[IBSU_MAX_STR_LEN];
    /** Device firmware version. */
    wchar_t fwVersion[IBSU_MAX_STR_LEN];
    /** Device revision. */
    wchar_t devRevision[IBSU_MAX_STR_LEN];
    /** Return device handle. */
    int   handle;
    /** Check if device handle is opened. */
    BOOL  IsHandleOpened;
    ...
    BOOL IsDeviceLocked;
    /* CustomerString to display */
    wchar_t customerString[IBSU_MAX_STR_LEN];
}
IBSU_DeviceDescW;
...
/**
****************************************************************************************************
* @defgroup group_Structure_Property_AlcorLink Structure - Property of AlcorLink Device
* @brief    Container for Properteis of Alcorlink device
* @{
****************************************************************************************************
*/
...
/**
****************************************************************************************************
* @defgroup group_Structure_Segmentation_Position Structure - Coordinates of Segments
* @brief    Container to hold segment information.
* @{
****************************************************************************************************
*/
typedef struct
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_ImageType Enumeration - Image Type
* @brief    Enumeration of image types.  The image type is passed as a parameter to API functions
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_ImageResolution Enumeration - Image Resolution
* @brief    Enumeration of image resolutions.  The image resolution is passed as a parameter to API
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_PropertyID Enumeration - Property ID
* @brief    Enumeration of property IDs.  Properties can be gotten with IBSU_GetProperty(); some properties
...
typedef enum
{
	...
	/** Enable decimation mode (TRUE to enable or FALSE to disable).
        * Some devices (or firmware version) do not support this feature.	[Get and set.]*/
	...
	/** Enable capture on release (TRUE to enable or FALSE to disable). The default is FALSE.  [Get and set.]
        * TRUE  : The result callback will be called when the user releases fingers from the sensor.
        * FALSE : The result callback will be called when the quality of the finger is good */
	ENUM_IBSU_PROPERTY_ENABLE_CAPTURE_ON_RELEASE,

	/** The device index. [Get only.] */
	ENUM_IBSU_PROPERTY_DEVICE_INDEX,

	/** The device ID which shares information with the UsbDevice class of Android. [Get only.] */
	ENUM_IBSU_PROPERTY_DEVICE_ID,

	/** This can be used for dry finger
        * Some devices (or firmware version) do not support this feature.
        * The default is FALSE. [Get and set.]
        * TRUE  : Enable dry mode.
        * FALSE : Disable dry mode */
	ENUM_IBSU_PROPERTY_SUPER_DRY_MODE,

	/** There is a minimum capture time when dry mode is enabled with the property ENUM_IBSU_PROPERTY_SUPER_DRY_MODE
        * Some devices (or firmware version) do not support this feature.
	...
	/** Check if the device supprorts spoof analysis functionality [Get only.] */
	ENUM_IBSU_PROPERTY_IS_SPOOF_SUPPORTED,
	...
	* The default value of 3 should be used as the baseline sensitivity when tuning application performance.
	*
	...
	*
	* Spoof sensitivity is the scale for algorithm thresholds that determines the liklihood that a fingerprint
	* is fake, or a spoof. The feature is designed so that the algorithm returns a warning callback when a
	* spoof is detected */
	ENUM_IBSU_PROPERTY_SPOOF_LEVEL,
	...
	/** Enhanced roll Method
        * The default value is 0.  [Get and set.] */
	ENUM_IBSU_PROPERTY_ROLL_METHOD,

	/** Select a level of opposite image value during roll
        * The default value is 0.  [Get and set.] 
	    * 0 : No use
	...
	/** Enable High quality preview image for Kojak
        * The default value is 0.  [Get and set.] */
	ENUM_IBSU_PROPERTY_PREVIEW_IMAGE_QUALITY_FOR_KOJAK,

	/** Enable Adaptive Capture
        * The default value is TRUE. [Get only.] */
	ENUM_IBSU_PROPERTY_ADAPTIVE_CAPTURE_MODE,

	/** Enable Kojak 2.6 behavior
        * The default value is FALSE.  [Get and set.] */
	ENUM_IBSU_PROPERTY_ENABLE_KOJAK_BEHAVIOR_2_6,

	/** Disable Segment rectangles rotation
        * The default value is FALSE.  [Get and set.] */
	ENUM_IBSU_PROPERTY_DISABLE_SEGMENT_ROTATION,

    /** Enable Zoom-In mode : It sets Zoom-In when fingers start being detected in DR mode.
        * The default value is TRUE.  This property only set FALSE in WINDOWS.
	...
	/** The preview image processing threshold. [Need a partner or reserve code] 
	...
	/** Change brightness threshold for flat capture
        * The default values are dependant on the scanner.  [Get and set.] */
	ENUM_IBSU_PROPERTY_RESERVED_CAPTURE_BRIGHTNESS_THRESHOLD_FOR_FLAT,
	...
	/** Change level of Slip detection
        * The default value is 3. The Range is from 1 to 10.  [Get and set.] */
	ENUM_IBSU_PROPERTY_RESERVED_SLIP_DETECTION_LEVEL,

	/** Enable Trick Capture
        * The default value is TRUE. [Get and set.] */
	ENUM_IBSU_PROPERTY_RESERVED_ENABLE_TRICK_CAPTURE,

    /** Enable to set CBP operation  mode
     * The default value is FALSE.  [Get and set.] */
    ENUM_IBSU_PROPERTY_RESERVED_ENABLE_CBP_MODE,

	/* Raw Image width value.  [Get only.] */
    ENUM_IBSU_PROPERTY_RESERVED_RAW_IMAGE_WIDTH,

    /* Raw Image height value.  [Get only.] */
    ...
    ENUM_IBSU_PROPERTY_RESERVED_RECALCILATE_BRIGHTNESS,
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_Client_Window_PropertyID Enumeration - Property ID for Client Window
* @brief    Enumeration of client window property IDs.  Properties can be retrieved with IBSU_GetClientWindowProperty();
...
typedef enum
{
    ...
    /** Color of the roll guide line.  The valid range is between 0x00000000 and 0xFFFFFFFF,
        * inclusive, with the default of 0x0000FF (Red Color). [Get and set.]  */
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_Finger_Count_State Enumeration - Finger Count State
* @brief    Enumeration of finger count states.
* @{
****************************************************************************************************
*/
typedef enum
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_Finger_Quality_State Enumeration - Finger Count State
* @brief    Enumeration of finger quality states.
* @{
****************************************************************************************************
*/
typedef enum
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_LE_Operation_Mode Enumeration - LE Operation Mode
* @brief    Enumeration of light emitting (LE) file operation modes.
* @{
****************************************************************************************************
*/
typedef enum
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_Platen_State Enumeration - Platen State
* @brief    Enumeration of platen states.
* @{
****************************************************************************************************
*/
typedef enum
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_Callback_Event Enumeration - Callback Events
* @brief    Enumeration of events that can trigger callbacks
* @{
****************************************************************************************************
*/
typedef enum
{
    ...
    /** Callback when the result image is available for a capture (with extended information). */
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_LED_Type Enumeration - LED Type
* @brief    Enumeration of LED types.
* @{
****************************************************************************************************
*/
typedef enum
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_Rolling_State Enumeration - Rolling State
* @brief    Enumeration of rolling print acquisition states.
* @{
****************************************************************************************************
*/
typedef enum
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_Client_Window_Over_Shape_Pattern_Type Enumeration - Client Window - Overlay Pattern Type
* @brief    Enumeration of the shape pattern to use for the overlay on client window.
* @{
****************************************************************************************************
*/
typedef enum
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_Combine_Two_Finger_Image_Type Enumeration - Combine Two Finger Image Type
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_Beeper_Type Enumeration - Beeper Type
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_Beeper_Pattern Enumeration - Beeper Pattern
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_Encryption_Mode Enumeration - Encryption Mode
* @brief    Enumeration of the Encryption Mode.
* @{
****************************************************************************************************
*/
typedef enum
{
    ...
    /** Default Key for Development (only for IB Engineer) */
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_Matcher_Image_Format Enumeration - Matcher - Image format
* @brief    Enumeration of image formats to support IBScanMatcher integration.
* @{
****************************************************************************************************
*/
typedef enum
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_Matcher_Image_Impression_Type Enumeration - Matcher - Image Impresstion Type
* @brief    Enumeration of image impression types to support IBScanMatcher integration.
* @{
****************************************************************************************************
*/
typedef enum
{
    ...
    IBSM_IMPRESSION_TYPE_LIVE_SCAN_OPTICAL_CONTRCTLESS_ROLLED=25,
    IBSM_IMPRESSION_TYPE_MOVING_SUBJECT_CONTRCTLESS_PLAIN=41,
    IBSM_IMPRESSION_TYPE_MOVING_SUBJECT_CONTRCTLESS_ROLLED=42,
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_Matcher_Finger_Position Enumeration - Matcher - Finger Position
* @brief    Enumeration of finger positions to support IBScanMatcher integration.
* @{
****************************************************************************************************
*/
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_Matcher_Capture_Device_Tech_ID Enumeration - Matcher - Capture Device Tech ID
* @brief    Enumeration of capture device technology IDs to support IBScanMatcher integration.
* @{
****************************************************************************************************
*/
typedef enum
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_Matcher_Supported_Device Enumeration - Matcher - Supported Device
* @brief    Enumeration of capture device type IDs to support IBScanMatcher integration.
* @{
****************************************************************************************************
*/
typedef enum
{
	...
	IBSM_CAPTURE_DEVICE_TYPE_ID_MANNIX = 0x1D00,
}
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_Matcher_Vendor_ID Enumeration - Matcher - Vendor ID
* @brief    Enumeration of capture device vendor IDs to support IBScanMatcher integration.
* @{
****************************************************************************************************
*/
typedef enum
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_Matcher_Hash_Type Enumeration - Matcher - Hash Type
* @brief    Enumeration of the Hashtype.
* @{
****************************************************************************************************
*/
typedef enum
...
/**
****************************************************************************************************
* @defgroup group_Structure_Matcher_Image_Data Structure - Matcher - Image Data
* @brief    Container for image information to support IBScanMatcher integration.
* @{
****************************************************************************************************
*/
typedef struct
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_Matcher_Template_Version Enumeration - Matcher - Template Version
* @brief    Enumeration of Template versions to support ISO/ANSI integration.
* @{
****************************************************************************************************
*/
...
/**
****************************************************************************************************
* @defgroup group_Structure_Matcher_Template_Data Structure - Matcher - Template Data
* @brief    Container for Template information to support ISO/ANSI integration.
* @{
****************************************************************************************************
*/
typedef struct
...
/**
****************************************************************************************************
* @defgroup group_Enumeration_Matcher_Standard_Format_Type Enumeration - Matcher - Standard Format Type
* @brief    Enumeration of Standard Format types to support ISO/ANSI integration.
* @{
****************************************************************************************************
*/
typedef enum
{
    ...
    /** ISO 39794-4:2019 */
    ENUM_IBSM_STANDARD_FORMAT_ISO_39794_4_2019,
}
IBSM_StandardFormat;
/**
****************************************************************************************************
...
/**
****************************************************************************************************
* @defgroup group_Structure_Matcher_Standard_Format_Data Structure - Matcher - Standard Format Data
* @brief    Container for Standard format data information to support ISO/ANSI integration.
* @{
****************************************************************************************************
*/
typedef struct
...
/**
****************************************************************************************************
* @defgroup group_Def_Interface_Callbacks Definition - Callback Interface Functions
* @brief    Definition for the Interface functions of the Callbacks.
* @{
****************************************************************************************************
*/
/**
...
* @param
*     qualityArrayCount  Number of qualities in an array.
****************************************************************************************************
*/
...
*
* @param
*     deviceIndex    Zero-based index of a device.
* @param
*     pContext       User context.
* @param
...
*
* @brief
*     Callback for ::ENUM_IBSU_ESSENTIAL_EVENT_ASYNC_OPEN_DEVICE, called when asynchronous device
...
*     pContext           User context.
* @param
*     pressedKeyButtons  The key button index that is pressed.
****************************************************************************************************
*/
