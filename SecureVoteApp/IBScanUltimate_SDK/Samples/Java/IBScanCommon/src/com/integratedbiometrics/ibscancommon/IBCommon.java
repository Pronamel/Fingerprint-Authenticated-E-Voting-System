...
*
* @copyright
*       Copyright (c) Integrated Biometrics, 2013-2023 \n
*       http://www.integratedbiometrics.com
*
* @page page_API_Revision_History_IBCommon IBCommon.java
* @section section_IBCommon IBCommon.java
* @li @par  2022/04/14
*						Added StandardFormatData Class structure\n
...
/**
****************************************************************************************************
* @defgroup group_API_Common_Class_IBCommon Class - IBCommon
* @{
****************************************************************************************************
*/
/**
* @brief	Class encapsulating matcher functionality.
*/
public class IBCommon 
{
	...
	/**
	****************************************************************************************************
	* @defgroup group_API_Common_Nested_Class_ImageDataExt Class - IBCommon.ImageDataExt
	* @brief    Container to hold image data together with extended meta data.
	* @{
	****************************************************************************************************
	*/
	...
	*/
	...
	/**
	****************************************************************************************************
	* @defgroup group_API_Common_Nested_Class_StandardFormatData Class - IBCommon.StandardFormatData
	* @brief    Container to hold image data StandardFormatData (IBSM_StandardFormatData)
	* @{
	****************************************************************************************************
	*/
	...
	*/
	...
	/**
	****************************************************************************************************
	* @defgroup group_API_Common_Nested_Enum_ImageFormat Enum - IBCommon.ImageFormat
	* @brief    Image formats.
	* @{
	****************************************************************************************************
	*/
	...
	*/
    ...
    /**
	****************************************************************************************************
	* @defgroup group_API_Common_Nested_Enum_ImpressionType Enum - IBCommon.ImpressionType
	* @brief    Impression types.
	* @{
	****************************************************************************************************
	*/
	...
	*/
    ...
    /**
	****************************************************************************************************
	* @defgroup group_API_Common_Nested_Enum_FingerPosition Enum - IBCommon.FingerPosition
	* @brief    Finger positions.
	* @{
	****************************************************************************************************
	*/
	...
	*/
    ...
    /**
	****************************************************************************************************
	* @defgroup group_API_Common_Nested_Enum_CaptureDeviceTechId Enum - IBCommon.CaptureDeviceTechId
	* @brief    Capture device technology ID.
	* @{
	****************************************************************************************************
	*/
	...
	*/
    ...
    /**
	****************************************************************************************************
	* @defgroup group_API_Common_Nested_Enum_StandardFormat Enum - IBCommon.StandardFormat
	* @brief    StandardFormat (IBSM_StandardFormat)
	* @{
	****************************************************************************************************
	*/
    public static enum StandardFormat
    {
    	...
    	STANDARD_FORMAT_ISO_39794_4_2019(6);
